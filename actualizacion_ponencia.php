...
//conectar con el servidor
	$conn = mysql_connect("$host", "$user", "$pass");
		...
		////////////////////////// FUNCIÓN PARA EJECUTAR QUERY
				...
				$query = "UPDATE ponencias_oral SET RFC = '$rfc_autor', titulo_oral = '$titulo', resumen_oral = '$resumen', referencias_oral = '$referencias', id_categoria = '$categoria', id_modalidad = '$modalidad' WHERE id_ponencia_oral = '$id_trabajo' ";
				exe_query($query);
				...
				if ($rfc_coautor1 != "" && $coautor1 == "") {
					$query="INSERT INTO autores VALUES ('$rfc_coautor1', 'coautor1', 'T05' , '$id_trabajo', '$requiere1')";
					exe_query($query);
				}
				...
				if ($rfc_coautor2 != "" && $coautor2 == "") {
					$query="INSERT INTO autores VALUES ('$rfc_coautor2', 'coautor2', 'T05' , '$id_trabajo', '$requiere2')";
					exe_query($query);
				}
				...
				if ($rfc_coautor3 != "" && $coautor3 == "") {
					$query="INSERT INTO autores VALUES ('$rfc_coautor3', 'coautor3', 'T05' , '$id_trabajo', '$requiere3')";
					exe_query($query);
				}
				...
				if ($rfc_coautor4 != "" && $coautor4 == "") {
					$query="INSERT INTO autores VALUES ('$rfc_coautor4', 'coautor4', 'T05' , '$id_trabajo', '$requiere4')";
					exe_query($query);
				}
