	...
	$conn = mysql_connect("$host", "$user", "$pass");
		...
		$r4 = mysql_query($query4);
				if(!$r4){
					...
					echo "<textarea  rows='1' cols='50' name='resumen_confirma' id='resumen' >".$resumen."</textarea>";
					//echo "<legend id='edicion'>Referencias:</legend>";
					echo "<textarea  rows='1' cols='50' name='referencias_confirma'id='referencias'>".$referencias."</textarea>";
