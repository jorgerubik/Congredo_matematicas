    ...
    <table class="maintable" cellspacing="0" cellpadding="0">
      ...
      <br></br><br></br>
        <td class="nomail">              
          ...
          <font color="black"><h3>Clave del curso: '.$codigo_curso.'</h3></font>
        <font color="black"><h3> No se han registrado coautores en el trabajo, podr&aacute; registrarlos posteriormente
         ...
         <font color="black"><h3>Nota: por favor no olviden estar atentos a las fechas de <br>revisi&oacute;n de trabajos y env&iacute;o de resultados.</h3></font><br><br>
                    </td></tr>                 
                    </table></td></tr>
...
<body>
  <center>
    <table class="maintable" cellspacing="0" cellpadding="0">
      ...
      '.$rfc_coautor4.'
          <br>
      <font color="black"><h3>Nota: por favor no olviden estar atentos a las fechas de <br>revisi&oacute;n de trabajos y env&iacute;o de resultados.</h3></font><br><br>                    </td></tr>                 
                    </table></td></tr>
              <td class="bottom">&nbsp;</td></tr>
          </table>
      </center>      
