...
//conectar con el servidor
	$conn = mysql_connect("$host", "$user", "$pass");
		...
		$query = "SELECT * FROM ponencias_cartel WHERE RFC = '".$rfc."'"." AND id_ponencia_cartel ='".$id_trabajo."'";
					$r = mysql_query($query);
					if(!$r){
					...
					while ($row = mysql_fetch_assoc($r)){
						...
						echo"<form action='editar_cartel_confirma.php' method='post' autocomplete='on' class='forms'>";
						echo"<fieldset id='ponencia'><legend>Formulario de registro</legend>";
						...
						echo"<legend>Modalidad (Solo seleccionar una):</legend>";
						echo"<select id='Modalidad' name='modalidad'>";
						echo"<option>Modalidad</option>";
						...
						echo"<textarea rows='6' cols='50' id='Contenido_area' name='Resumen' required onblur='wordCount();'>".$row['resumen_cartel']." </textarea>";
						echo"</fieldset><fieldset>";
						echo"<legend>Referencias (máximo 30 palabras)</legend>";
						echo"<textarea row='6' cols='50' name='Referencias' id='Contenido_area2' required  onblur='wordCountc();'>".$row['referencias_cartel']."</textarea>";
						echo"</fieldset><fieldset>";
						echo"<legend>Autores</legend>";
						echo"<table border='1' id='autores'>";
						echo"<tr><th>Autor</th><th>RFC</th><th>Requiere constancia</th></tr>";
						echo"<tr><th>Autor</th>";
						echo"<td><input type='text' id='id_ponente' name='Rfc_autor' value='".$rfc."' maxlenght='10' required></td>";
					//querys para verificar constancias de autores y coautores
						$query_requiere = "SELECT constancia FROM autores WHERE RFC = '".$rfc."'"." AND id_trabajo = '".$id_trabajo."'";
							 ...
							 $row_co4 = mysql_fetch_array($result_co4); 
  							 ...
  							 echo "<td><input type='text' id='id_ponente' name='Rfc_coautor1' value='".$rco1."'></td> ";
							 ...
							 $row_requiere1 = mysql_fetch_array($result_requiere1); 
  							 ...
  							 echo "<td><input type='text' id='id_ponente' name='Rfc_coautor2' value='".$rco2."'></td> ";
							 ...
							 $row_requiere2 = mysql_fetch_array($result_requiere2); 
  							 ...
  							 echo "<td><input type='text' id='id_ponente' name='Rfc_coautor3' value='".$rco3."'></td> ";
							 ...
							 $row_requiere3 = mysql_fetch_array($result_requiere3); 
  							 ...
  							 echo "<td><input type='text' id='id_ponente' name='Rfc_coautor4' value='".$rco4."'></td> ";
